...
class AttributeContext_Request extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AttributeContext.Request', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$4.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'time', subBuilder: $4.Timestamp.create)
  ...
  @$pb.TagNumber(9)
  $4.Timestamp get time => $_getN(7);
  @$pb.TagNumber(9)
  set time($4.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTime() => $_has(7);
  @$pb.TagNumber(9)
  void clearTime() => clearField(9);
  @$pb.TagNumber(9)
  $4.Timestamp ensureTime() => $_ensure(7);
...
class AttributeContext_Response extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AttributeContext.Response', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$5.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backendLatency', subBuilder: $5.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $5.Duration get backendLatency => $_getN(4);
  @$pb.TagNumber(5)
  set backendLatency($5.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBackendLatency() => $_has(4);
  @$pb.TagNumber(5)
  void clearBackendLatency() => clearField(5);
  @$pb.TagNumber(5)
  $5.Duration ensureBackendLatency() => $_ensure(4);
}
...
class AttributeContext_Resource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AttributeContext.Resource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$4.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deleteTime', subBuilder: $4.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $4.Timestamp get createTime => $_getN(7);
  @$pb.TagNumber(8)
  set createTime($4.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCreateTime() => $_has(7);
  @$pb.TagNumber(8)
  void clearCreateTime() => clearField(8);
  @$pb.TagNumber(8)
  $4.Timestamp ensureCreateTime() => $_ensure(7);

  @$pb.TagNumber(9)
  $4.Timestamp get updateTime => $_getN(8);
  @$pb.TagNumber(9)
  set updateTime($4.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUpdateTime() => $_has(8);
  @$pb.TagNumber(9)
  void clearUpdateTime() => clearField(9);
  @$pb.TagNumber(9)
  $4.Timestamp ensureUpdateTime() => $_ensure(8);

  @$pb.TagNumber(10)
  $4.Timestamp get deleteTime => $_getN(9);
  @$pb.TagNumber(10)
  set deleteTime($4.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDeleteTime() => $_has(9);
  @$pb.TagNumber(10)
  void clearDeleteTime() => clearField(10);
  @$pb.TagNumber(10)
  $4.Timestamp ensureDeleteTime() => $_ensure(9);
...
class AttributeContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AttributeContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..pc<$3.Any>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'extensions', $pb.PbFieldType.PM, subBuilder: $3.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $core.List<$3.Any> get extensions => $_getList(7);
}
